...
function scn(){
  ...
  return (
    <div style={{width:'100%',display:'flex',alignItems: 'center',flexDirection:'column'}}>
      ...
      <p onClick={genr} className={classes.el} >QR code scanner</p>
      <p onClick={scn} className={classes.el} >QR code generator</p>
    </div>
...
<div id='ff' style={{display:'none'}}>
                          ...
                          <br/>
                          <TextField label="order id " onChange={(e) => setText2(e.target.value)}/>
